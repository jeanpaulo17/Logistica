...
public class TelaEditarAmostra extends JFrame {
	...
	public TelaEditarAmostra() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(TelaEditarAmostra.class.getResource("/face/proposta_icon.png")));
		...
		lblimg.setIcon(new ImageIcon(TelaEditarAmostra.class.getResource("/face/proposta.png")));
