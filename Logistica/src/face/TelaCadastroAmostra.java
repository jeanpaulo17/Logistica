...
public class TelaCadastroAmostra extends JFrame {
	...
	public TelaCadastroAmostra() {
		...
		btnCadastar.setBounds(417, 219, 89, 23);
		...
		btnCancelar.setBounds(516, 219, 89, 23);
		...
		lblPeriodicidade.setBounds(27, 219, 139, 20);
		...
		comboBox.setBounds(176, 220, 220, 20);
		...
		separator.setBounds(10, 266, 1056, 2);
		...
		ScrolPaneDashBoard.setBounds(10, 275, 1056, 348);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					amostraDAO.PreencherTabela(
							"select p.numero PROPOSTA ,a.numero AMOSTRA ,a.ponto PONTO, a.periodicidade PERIODO "
									+ "from proposta as p , amostra as a where p.numero = a.proposta and p.numero='"
									+ txtProposta.getText() + "'",
							dados);
		...
		txtProposta.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				txtEmpresa.setText(amostraDAO.buscarEmpresa(txtProposta.getText()));
			...
			public void itemStateChanged(ItemEvent arg0) {
				...
				try {
					...
					parametroDAO.PreencherTabelaParametro(
							"select  ap.proposta , ap.amostra , pr.empresa, am.ponto , pa.descricao as parametro, fr.descricao as frasco, "
									+ "pre.descricao as preservacao, vol.volume as volume, uni.unidade_medida as unidademedida, tip.descricao as tipoamostra from amostra_parametro as ap, "
									+ "proposta as pr , amostra as am , parametro as pa, frasco as fr, preservacao as pre, volume as vol, tipoamostra as tip, "
									+ "unidade_medida as uni where ap.amostra='" + cbNumeroAmostra.getSelectedItem()
									+ "' and pr.numero= '" + txtProposta_Amostra.getText() + "' and am.proposta='"
									+ txtProposta_Amostra.getText() + "' "
									+ "and am.numero = ap.amostra and ap.parametro = pa.idparametro and pr.numero = ap.proposta and fr.id_frasco = pa.frasco "
									+ "and pre.id_preservacao = pa.preservacao and vol.id_volume = pa.volume and tip.idtipoamostra = pa.tipoamostra "
									+ "and uni.id_unidade_medida = vol.id_unidade_medida",
							dados2);
		...
		btnAdicionarParametro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int codParametro = parametroDAO.obterCodigoParametro((String) cbParametro.getSelectedItem());

				if (parametroDAO.verificaCadastroParametro(numAmostra, codParametro, proposta) == "false") {
				...
				try {
					...
					txtEmpresa_Parametro.setText(amostraDAO.buscarEmpresa(txtProposta_Amostra.getText()));

					for (int i = 0; i <= amostras.size() - 1; i++)
						cbNumeroAmostra.addItem(amostras.get(i));

					parametroDAO1.PreencherTabelaParametro(
							"select  ap.proposta , ap.amostra , pr.empresa, am.ponto , pa.descricao as parametro, fr.descricao as frasco, "
									+ "pre.descricao as preservacao, vol.volume as volume, uni.unidade_medida as unidademedida, tip.descricao as tipoamostra from amostra_parametro as ap, "
									+ "proposta as pr , amostra as am , parametro as pa, frasco as fr, preservacao as pre, volume as vol, tipoamostra as tip, "
									+ "unidade_medida as uni where ap.amostra='" + cbNumeroAmostra.getSelectedItem()
		...
		txtProposta_Amostra.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				...
				ArrayList amostras;
				parametroDAO parametroDAO = new parametroDAO();
				amostras = parametroDAO.obterAmostra(txtProposta_Amostra.getText());
				txtEmpresa_Parametro.setText(amostraDAO.buscarEmpresa(txtProposta_Amostra.getText()));
				...
				try {
					...
					parametroDAO.PreencherTabelaParametro(
							"select  ap.proposta , ap.amostra , pr.empresa, am.ponto , pa.descricao as parametro, fr.descricao as frasco, "
									+ "pre.descricao as preservacao, vol.volume as volume, uni.unidade_medida as unidademedida, tip.descricao as tipoamostra from amostra_parametro as ap, "
									+ "proposta as pr , amostra as am , parametro as pa, frasco as fr, preservacao as pre, volume as vol, tipoamostra as tip, "
									+ "unidade_medida as uni where ap.proposta='" + txtProposta_Amostra.getText()
									+ "' and pr.numero= '" + txtProposta_Amostra.getText() + "' and ap.proposta= '"
									+ txtProposta_Amostra.getText() + "' and am.proposta='"
									+ txtProposta_Amostra.getText() + "' and ap.amostra = '"
									+ cbNumeroAmostra.getSelectedItem() + "'"
									+ "and am.numero = ap.amostra and ap.parametro = pa.idparametro and pr.numero = ap.proposta and fr.id_frasco = pa.frasco "
									+ "and pre.id_preservacao = pa.preservacao and vol.id_volume = pa.volume and tip.idtipoamostra = pa.tipoamostra "
									+ "and uni.id_unidade_medida = vol.id_unidade_medida",
