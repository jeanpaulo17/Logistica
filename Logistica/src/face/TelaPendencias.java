...
import utilitarios.EstoqueRenderer;
...
public class TelaPendencias extends JFrame {
	...
	public TelaPendencias() {
		...
		tableColeta.setDefaultRenderer(Object.class,
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(
						TelaPendencias.class
								.getResource("/face/definir-data_icon.png")));
		...
		panelDatas
				.setBorder(new TitledBorder(UIManager
						.getBorder("TitledBorder.border"), "Definir Datas",
		...
		final JRadioButton rdbtnNaoDatadas = new JRadioButton(
				"N\u00E3o Datadas");
		...
		lblBoletim.setBounds(10, 230, 139, 14);
		panelDatas.add(lblBoletim);

		txtBoletim = new JTextField();
		txtBoletim.setBounds(147, 227, 139, 20);
		...
		btnDefinir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int prop = Integer.valueOf(amostraDAO
						.buscarIdProposta(txtPropostaAuto.getText()));
				int amost = Integer.valueOf(amostraDAO
						.buscarIdAmostra(txtAmostraAuto.getText()));
				int ordem = Integer.valueOf(txtOrdemAuto.getText());
				String status = String.valueOf(cbStatus.getSelectedItem());

				if (cbcoletor.getSelectedItem().equals(" ")
						&& txtDataCol.getDate() == null
						&& !cbStatus.getSelectedItem().equals(" ")
						&& (txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirStatus(Integer.valueOf(amostraDAO
								.buscarIdProposta(txtPropostaAuto.getText())),
								Integer.valueOf(amostraDAO
										.buscarIdAmostra(txtAmostraAuto
												.getText())), Integer
										.valueOf(txtOrdemAuto.getText()),
				...
				else if (!cbcoletor.getSelectedItem().equals(" ")
						&& txtDataCol.getDate() == null
						&& cbStatus.getSelectedItem().equals(" ")
						&& (txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirColetor(Integer.valueOf(amostraDAO
								.buscarIdProposta(txtPropostaAuto.getText())),
								Integer.valueOf(amostraDAO
										.buscarIdAmostra(txtAmostraAuto
												.getText())), Integer
					...
					try {
						String datacoleta = new SimpleDateFormat("dd/MM/yyyy")
								.format(txtDataCol.getDate());
						boolean ok = amostraDAO.verificarDiasIguais(datacoleta,
								prop, amost);

						if (ok == false) {
							amostraDAO.DefinirData(
									Integer.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())),
									Integer.valueOf(amostraDAO
											.buscarIdAmostra(txtAmostraAuto
													.getText())), Integer
						...
						&& (txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirStatusColetor(Integer
								.valueOf(amostraDAO
										.buscarIdProposta(txtPropostaAuto
												.getText())), Integer
								.valueOf(amostraDAO
										.buscarIdAmostra(txtAmostraAuto
												.getText())), Integer
								.valueOf(txtOrdemAuto.getText()), String
								.valueOf(cbcoletor.getSelectedItem()), String
								.valueOf(cbStatus.getSelectedItem())
					...
					try {
						...
						if (ok == false) {
							amostraDAO.DefinirStatusData(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
											.buscarIdAmostra(txtAmostraAuto
													.getText())), Integer
									.valueOf(txtOrdemAuto.getText()),
									datacoleta, String.valueOf(cbStatus
											.getSelectedItem())
						...
						&& !(txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirBoletim(Integer.valueOf(amostraDAO
								.buscarIdProposta(txtPropostaAuto.getText())),
								Integer.valueOf(amostraDAO
										.buscarIdAmostra(txtAmostraAuto
												.getText())), Integer
						...
						&& !(txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirBoletimColetor(Integer
								.valueOf(amostraDAO
										.buscarIdProposta(txtPropostaAuto
												.getText())), Integer
								.valueOf(amostraDAO
										.buscarIdAmostra(txtAmostraAuto
												.getText())), Integer
								.valueOf(txtOrdemAuto.getText()), String
								.valueOf(txtBoletim.getText()), String
								.valueOf(cbcoletor.getSelectedItem()));
						...
						&& !(txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirBoletimStatus(Integer
								.valueOf(amostraDAO
										.buscarIdProposta(txtPropostaAuto
												.getText())), Integer
								.valueOf(amostraDAO
						...
						&& !(txtBoletim.getText().isEmpty())) {
					try {
						amostraDAO.DefinirBoletimColetorStatus(Integer
								.valueOf(amostraDAO
										.buscarIdProposta(txtPropostaAuto
												.getText())), Integer
								.valueOf(amostraDAO
					...
					try {
						...
						if (ok == false) {
							amostraDAO.DefinirBoletimData(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
											.buscarIdAmostra(txtAmostraAuto
													.getText())), Integer
									.valueOf(txtOrdemAuto.getText()),
									datacoleta, String.valueOf(txtBoletim
											.getText()));
					...
					try {
						...
						if (ok == false) {
							amostraDAO.DefinirBoletimDataColetor(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
					...
					try {
						...
						if (ok == false) {
							amostraDAO.DefinirBoletimDataStatus(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
					...
					try {
						...
						if (ok == false) {
							...
							amostraDAO.DefinirDataColetor(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
											.buscarIdAmostra(txtAmostraAuto
													.getText())), Integer
									.valueOf(txtOrdemAuto.getText()),
									datacoleta, String.valueOf(cbcoletor
											.getSelectedItem()));
					...
					try {
						...
						if (ok == false) {
							...
							amostraDAO.DefinirDataStatusColetor(Integer
									.valueOf(amostraDAO
											.buscarIdProposta(txtPropostaAuto
													.getText())), Integer
									.valueOf(amostraDAO
		...
		btnDatasPesquisar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (txtdatacompara1.getDate() == null
						&& txtdatacompara2.getDate() == null) {
					if (rdbtnCancelada.isSelected()) {
						// canceladas
				...
				else if (txtdatacompara1.getDate() == null
						&& txtdatacompara2.getDate() != null) {
					...
					if (rdbtnCancelada.isSelected()) {
						...
						sql = "SELECT pr.numero_proposta as proposta, pr.empresa, am.numero_amostra as amostra, am.ponto, os.boletim, os.ordem , os.coletor as coletor, os.datacoleta, "
								...
								+ datacoleta
								+ "' and os.proposta = pr.idproposta and os.amostra = am.idamostra "
								+ " and st.descricao = os.status_amostra "
								+ " order by amostra,ordem";
